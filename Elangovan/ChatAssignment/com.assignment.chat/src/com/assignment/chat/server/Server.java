...
public class Server {
	...
	public void start() {
		...
		try {
			...
			ServerSocket serverSocket = createSocket(port);

			//Connect a client
			clientConnect(serverSocket);
			// Ask a client thread to stop
			serverDisconnect(serverSocket);
		}
		catch (IOException e) {
	...
	/**
	 * Creates a socket based on given port
	 * @return ServerSocket
	 */
     ...
     */
	public void serverDisconnect(ServerSocket serverSocket) {
		try {
			serverSocket.close();
	...
	public void clientConnect(ServerSocket serverSocket) {
